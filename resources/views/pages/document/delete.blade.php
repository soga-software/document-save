<!-- Delete Modal -->
<div class="modal fade compose-modal" id="deleteDocument" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="card mb-0 p-3">
                    <div class="pull-right">
                        <a id="deleteBtn" href="#"  class="btn btn-gradient-danger waves-effect waves-light">
                            <span>Xóa</span>
